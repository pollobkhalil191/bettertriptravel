...
export default function Destination() {
  ...
  aria-label={`Explore tours for ${destination.title}`}  // Added accessibility improvement
>
  <div className="relative flex-shrink-0 w-[180px] h-[220px] overflow-hidden rounded-lg group cursor-pointer">
    <Image
      src={destination.image}
      alt={`Image of ${destination.title}`}  // Enhanced alt text for better accessibility
      width={180}
      height={200}
